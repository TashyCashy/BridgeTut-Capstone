...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        // requires getDeclarer() and getWinningStrain() added to BiddingManager - see chat
        PlayerPosition declarerPosition = manager.getDeclarer().getSeatPosition();
        Suit trumpSuit = manager.getWinningStrain().toSuit(); // returns null automatically if NO_TRUMP
